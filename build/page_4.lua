...
function new() 
    ...
    local drawScreen = function() 
       ...
       --Animations
       local onEnd_linearEntry_388 = function() 
          actNextPage(); 
       end --ends reStart for linearEntry 
       gtStash.gt_linearEntry = gtween.new( kwkentradaMuseo, 5, {  x=830, y=1340,  alpha=1, rotation=0, xScale=3.6, yScale=3.6,}, {ease = gtween.easing.linear, repeatCount = 1, reflect = false,  delay=1, onComplete=onEnd_linearEntry_388}) 
       ...
       function actNextPage(event) 
            ...
            timerStash.newTimer_406 = timer.performWithDelay(0, myClosure_switch, 1) 
       end 
