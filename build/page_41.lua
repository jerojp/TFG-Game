...
_G.LastPageLevel[_G.Level].phase = _G.Phase 
       ...
       FondoPoloSurBar = display.newImageRect( imgDir.. "p41_fondopolosurbar.png", 1280, 800 ); 
       ...
       kwkesq_seq = { name = "default", start = 1, count = 9, time = 1000, loopCount = 0, loopDirection = "forward" }; 
